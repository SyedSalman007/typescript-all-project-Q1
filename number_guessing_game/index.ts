...
function randomNumberGenerator(level: string)
{   
...
async function gameStart(level: string)
{
    let number_to_guess:number;
    let chances:number;
...
async function powerOn()
{
    ...
    do{
        ...
        if(result.answer != -1)
        {
            ...
            console.log(chalk.bgRed(`You win:\bBy guessing ${result.answer} with ${result.life} chance left:`))
        }
